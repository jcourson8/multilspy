...
from multilspy.multilspy_config import Language, JediServerConfig
...
class JediServer(LanguageServer):
    ...
    def __init__(self, config: JediServerConfig, logger: MultilspyLogger):
        """
        ...
        super().__init__(
            ...
            initialize_params,
            logger,
            ProcessLaunchInfo(cmd="jedi-language-server", cwd=initialize_params["rootPath"]),
            Language.PYTHON,
        )
