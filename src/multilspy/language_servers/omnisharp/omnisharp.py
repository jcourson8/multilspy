...
from multilspy.multilspy_config import Language, MultilspyConfig, OmniSharpConfig
...
class OmniSharp(LanguageServer):
    ...
    def __init__(self, config: OmniSharpConfig, logger: MultilspyLogger):
        """
        ...
        slnfilename = find_least_depth_sln_file(initialize_params["rootPath"])
        ...
        super().__init__(
            ...
            initialize_params,
            logger, 
            ProcessLaunchInfo(cmd=cmd, cwd=initialize_params["rootPath"]), 
            Language.CSHARP
        )
