...
from multilspy.multilspy_config import Language, MultilspyConfig, RustAnalyzerConfig
...
class RustAnalyzer(LanguageServer):
    ...
    def __init__(self, config: RustAnalyzerConfig, logger: MultilspyLogger):
        """
        ...
        super().__init__(
            config,
            logger,
            ProcessLaunchInfo(cmd=rustanalyzer_executable_path, cwd=initialize_params["rootPath"]),
            Language.RUST,
        )
